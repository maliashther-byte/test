  ...
  const embed = new EmbedBuilder()
    ...
    .setDescription(
      [
        ...
        "② Announcement posted → join the server → log screenshot proof → earn **+1 point**",
        "③ Miss deadline / leave early / skip requirements → **+1 strike**",
        "④ **2 strikes** before weekly reset → **−1 point** · Strikes reset every Monday",
        "⑤ Reach **15 points** → press Claim Reward below",
        "",
        "**Strikes issued for:**",
        "• Not joining within the time limit  •  Leaving before the leave announcement",
        "• Not completing listed requirements",
        "",
        "**Rules:**",
        "• Rejoins (same server, different announcement) = no reward, no strike",
        "• If max join cap is reached when you log proof = no reward, no strike",
        "• Messaging in this channel, announcements, or applications = 1h timeout",
        "",
        "**On Break?** Press the button below — fill in duration & reason.",
        "Owner approves/declines. If approved, no strikes or points during your break.",
      ].join("\n")
    )
